...
## Project Structure
    ...
    ├── playmaker_network_32900  # Django project configurations
...
1. Clone this repo and `cd playmaker_network_32900`
...
2. Clone this repo and `cd playmaker_network_32900`
